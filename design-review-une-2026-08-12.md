# Contrôle visuel — articles À la Une

Date : 12 août 2026

La nouvelle présentation conserve la densité des cartes tout en abandonnant le fond sombre et l’effet de vignette intrusive. Chaque article est désormais placé sur un fond ivoire nuancé, avec une bordure dorée fine, une ombre courte, un repère vertical doré, un portrait circulaire discret et une hiérarchie éditoriale claire : rubrique, titre, accroche, signature et lien de lecture. Le rendu observé dans l’aperçu est cohérent avec la charte or/crème du portail et garde les trois contenus lisibles dans une largeur réduite.

Points à confirmer lors de la validation technique : absence de débordement horizontal sur petits écrans, contraste du texte secondaire et comportement du survol sans déplacement intempestif.
