...
const NETWORKS = [
  {
    ...
    getUrl: (url: string, title: string, excerpt?: string, authorName?: string) => buildShareUrl("WhatsApp", { url, title, excerpt, authorName }),
  },
  {
    name: "X (Twitter)",
    color: "#000000",
    ...
    getUrl: (url: string, title: string, excerpt?: string, authorName?: string) => buildShareUrl("X (Twitter)", { url, title, excerpt, authorName }),
  },
  {
    name: "Facebook",
    color: "#1877F2",
    ...
    getUrl: (url: string, title: string, excerpt?: string, authorName?: string) => buildShareUrl("Facebook", { url, title, excerpt, authorName }),
  },
  {
    name: "LinkedIn",
    color: "#0A66C2",
    ...
    getUrl: (url: string, title: string, excerpt?: string, authorName?: string) => buildShareUrl("LinkedIn", { url, title, excerpt, authorName }),
  },
  {
    name: "Telegram",
    color: "#0088cc",
    ...
    getUrl: (url: string, title: string, excerpt?: string, authorName?: string) => buildShareUrl("Telegram", { url, title, excerpt, authorName }),
  },
];
