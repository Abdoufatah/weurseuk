...
const NETWORKS = [
  ...
  },
  {
    ...
    getUrl: (url: string, _title: string, ogUrl?: string) =>
      `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(ogUrl || url)}`,
    useOgUrl: true,
  },
  {
    name: "LinkedIn",
...
export default function ShareButtons({
  ...
  const handleShare = (network: (typeof NETWORKS)[number]) => {
    // Pour les réseaux qui supportent ogUrl (Facebook), utiliser l'URL OG dédiée
    const useOg = (network as { useOgUrl?: boolean }).useOgUrl && ogUrl;
    const shareLink = network.getUrl(shareUrl, title, useOg ? ogUrl : undefined);
